...
// 🔹 處理 middleware 的錯誤 function 要有四個參數
...
app.post('/user', async (req, res) => {
  try {
    ...
    // 🔸res.(狀態碼) (狀態碼 => 200:成功 | 201:成功建立 | 404:找不到...)
    // 此處使用可讀性更高的套件 => http-status-codes
    // 可省略為 res.status(StatusCodes.CREATED).json()
